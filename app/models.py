...
from sqlalchemy import Boolean, DateTime, Float, BigInteger, Integer, String, Text, ForeignKey
...
class User(Base):
    ...
    roi_cycles_completed: Mapped[int] = mapped_column(Integer, default=0)
    max_roi_cycles: Mapped[int] = mapped_column(Integer, default=4)
